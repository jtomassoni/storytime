...
type StoryFormProps = {
  story?: StoryWithCategories | Story
}
...
export function StoryForm({ story }: StoryFormProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    longDescription: (story as any)?.longDescription || "",
    ...
    selectedCategoryIds: (story && 'categories' in story && story.categories) ? story.categories.map((sc: { category: Category }) => sc.category.id) : [],
    selectedValues: story?.valuesTags || [],
    selectedTopics: story?.topicTags || [],
    selectedCultures: (story as any)?.cultureTags || [],
    selectedLanguages: (story as any)?.languageTags || [],
    selectedWarnings: (story as any)?.contentWarnings || [],
    representationTags: (story as any)?.representationTags?.join(", ") || "",
  })
